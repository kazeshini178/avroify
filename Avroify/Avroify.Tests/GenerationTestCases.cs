...
public class GenerationTestCases : TheoryData<GenerationTestCase>
{
    public GenerationTestCases()
    {
        Add(new GenerationTestCase()
        {
            ClassDefinition = """
                              using Avroify;
...
public class NullReferenceTypeTestCases : TheoryData<NullableContextOptions, GenerationTestCase>
{
    public NullReferenceTypeTestCases()
    {
        // Compiler Null Check off, reference types null by default
        Add(NullableContextOptions.Disable, new GenerationTestCase()
        {
            ClassDefinition = """
                              using Avroify;
                              using System.Collections.Generic;
        ...
        Add(NullableContextOptions.Enable, new GenerationTestCase()
        {
            ClassDefinition = """
                              using Avroify;
                              using System.Collections.Generic;
